...
public class MyHelp extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ForegroundColorSpan colorSpanB = new ForegroundColorSpan(Color.parseColor("#0099EE"));
        StyleSpan styleSpan_B  = new StyleSpan(Typeface.BOLD);
        //str.setSpan(styleSpan_B, 0, 38, Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
        //str.setSpan(colorSpanA, 39, 85, Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
